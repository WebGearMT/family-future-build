...
function ReputableAgents() {
  ...
  const filteredAgents = agents.filter((agent) => {
    ...
    const matchesFilter =
      selectedFilters.length === 0 || selectedFilters.includes(agent.category);
  ...
  return (
    <div className="relative w-full bg-gray-50 min-h-[927px] overflow-x-hidden">
      ...
      <NoticeBoardHeader
        ...
        description="Browse our selection of highly reputable agents to get the services you need."
        isMobile={isMobile}
      ...
      <NoticeItemGrid
        ...
        searchTerm={searchTerm}
        selectedFilters={selectedFilters}
        noResultsMessage="No agents found matching your criteria."
      />
    </div>
  );
}

export default ReputableAgents;
