  ...
  return (
    <div className="relative w-full bg-gray-50 min-h-[927px] overflow-x-hidden">
      ...
      <NoticeBoardHeader
        ...
        description="Browse our selection of highly reputable companies to get the services you need."
        isMobile={isMobile}
...
export default ReputableCompanies;
